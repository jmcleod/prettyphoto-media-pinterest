...
function ppm_pinterest_footer_script() {
	...
	$out .= '  jQuery(\'.pp_social\').append(\'<div class="pinterest"><a href="http://pinterest.com/pin/create/button/?url=\' + location.href + \'&media=\' + m + \'" class="pin-it-button" count-layout="none"><img border="0" src="//assets.pinterest.com/images/PinExt.png" title="Pin It" /></a></div>\');' . "\n";
	$out .= '}' . "\n";
	$out .= '</script>' . "\n";
